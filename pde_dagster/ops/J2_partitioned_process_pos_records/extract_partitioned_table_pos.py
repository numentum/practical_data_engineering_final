...
@op(name="extract_partitioned_table_pos_op", required_resource_keys={"postgres_resource"})
def extract_table_pos_op(context):
    ...
    df = extract_table("pos_transactions", pg_conn=pg_conn, start_time=start_time, end_time=end_time)
